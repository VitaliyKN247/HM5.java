...
public class HM5_2 {
    public static void main(String[] args) {
        ...
        filled.add(new Point(1, 4));  // где будет находиться начальная точка
        init(area, filled);
        ...
        do {
            ...
            print(area);
        } while (filled.size() != 0);   //проход по шагам в обратном порядке
    ...
    public static void print(int[][] area) {   // печать лабиринта
        for (int[] row : area) {
            for (int element : row) {
    ...
    private static class Point {
        ...
        /* 
         * equals и hashcode работают в связке.
         */
        @Override
        public int hashCode() {
